...
import lights.extensions.fuzzy.operators.SchweizerIntersection1;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SchweizerIntersection1Test extends Fixture {

	/**
	 * Constructor for SchweizerIntersection1Test.
	 * @param arg0
	 */
	public SchweizerIntersection1Test(String arg0) {
		super(arg0);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(SchweizerIntersection1Test.class);
	}
	...
	final public void testOperator() {
		try {
			...
			Assert.assertEquals(0.3736F, operator.operator(0.6F, 0.7F), 0.0001);
	...
	public void setUpOperator() {
		try {
			operator = new SchweizerIntersection1(0.5F);
		} catch (OutOfRangeException e) {
			Assert.fail();
		}
	}
