...
import lights.extensions.fuzzy.operators.SchweizerIntersection3;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SchweizerIntersection3Test extends Fixture {

    /**
     * Constructor for SchweizerIntersection3Test.
     * 
     * @param arg0
     */
    public SchweizerIntersection3Test(String arg0) {
        super(arg0);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SchweizerIntersection3Test.class);
    }
    ...
    final public void testOperator() {
        try {
            ...
            Assert.assertEquals(0.0341F, operator.operator(0.2F, 0.3F), 0.0001);
    ...
    final public void testParameter() {
        try {
            new SchweizerIntersection3(-0.5F);
    ...
    public void setUpOperator() {
        try {
            operator = new SchweizerIntersection3(0.5F);
        } catch (OutOfRangeException e) {
            Assert.fail();
        }
    }
