...
import lights.extensions.fuzzy.operators.DombiUnion;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DombiUnionTest extends Fixture {

	/**
	 * Constructor for DombiUnionTest.
	 * @param arg0
	 */
	public DombiUnionTest(String arg0) {
		super(arg0);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(DombiUnionTest.class);
	}
	...
	final public void testOperator() {
				try {
					...
					Assert.assertEquals(0.1032F, operator.operator(0.2F, 0.3F), 0.0001);
