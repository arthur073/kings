...
rem *** that starts all services in transient
...
-Dconfig=%EXAMPLE_HOME%\example\common\jsse\config\start-all-transient.config ^
...
%EXAMPLE_HOME%\example\common\jsse\config\start-all-transient.config
