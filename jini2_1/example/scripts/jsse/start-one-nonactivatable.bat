...
-Dconfig=%EXAMPLE_HOME%\example\common\jsse\config\start-one-nonactivatable.config ^
...
%EXAMPLE_HOME%\example\common\jsse\config\start-one-nonactivatable.config
