...
rem *** that starts all services in nonactivatable
...
-Dconfig=%EXAMPLE_HOME%\example\common\jsse\config\start-all-nonactivatable.config ^
...
%EXAMPLE_HOME%\example\common\jsse\config\start-all-nonactivatable.config
