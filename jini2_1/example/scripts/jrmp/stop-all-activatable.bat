...
rem *** activatable services are running under JRMP,
...
set REGGIE_PERSIST_DIR=C:\temp\jrmp-reggie-log
set MAHALO_PERSIST_DIR=C:\temp\jrmp-mahalo-log
set FIDDLER_PERSIST_DIR=C:\temp\jrmp-fiddler-log
set NORM_PERSIST_DIR=C:\temp\jrmp-norm-log
set NORM_JOINSTATE_DIR=%NORM_PERSIST_DIR%\JoinState
set MERCURY_PERSIST_DIR=C:\temp\jrmp-mercury-log
set OUTRIGGER_PERSIST_DIR=C:\temp\jrmp-outrigger-log
...
-DsharedVMLog=C:\temp\jrmp-all-sharedvm ^
