...
rem *** transient mode, running under JRMP
...
-Dconfig=%EXAMPLE_HOME%\example\common\jrmp\config\start-all-transient.config ^
...
%EXAMPLE_HOME%\example\common\jrmp\config\start-all-transient.config
