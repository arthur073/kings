...
rem *** that starts Phoenix running under JRMP
...
-Dconfig=%EXAMPLE_HOME%\example\common\jrmp\config\start-phoenix.config ^
...
%EXAMPLE_HOME%\example\common\jrmp\config\start-phoenix.config
