...
rem *** that starts all the services in
rem *** transient mode, running under JERI
...
-Dconfig=%EXAMPLE_HOME%\example\common\jeri\config\start-all-transient.config ^
...
%EXAMPLE_HOME%\example\common\jeri\config\start-all-transient.config
