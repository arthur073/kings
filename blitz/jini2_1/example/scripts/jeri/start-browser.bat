...
rem *** that starts the Browser running under JERI
...
-Dconfig=%EXAMPLE_HOME%\example\common\jeri\config\start-browser.config ^
...
%EXAMPLE_HOME%\example\common\jeri\config\start-browser.config
